...
public sealed class PurchaseReturnConfiguration : IEntityTypeConfiguration<PurchaseReturn>
{
    public void Configure(EntityTypeBuilder<PurchaseReturn> builder)
    {
        ...
        builder.HasIndex(e => e.OriginalPurchaseReceiptId);
        builder.HasIndex(e => e.Status);
        builder.HasIndex(e => e.ReturnDateUtc);
        builder.HasIndex(e => e.CreatedAtUtc);
        builder.HasIndex(e => new { e.Status, e.PostedAtUtc })
            .HasDatabaseName("IX_purchase_returns_status_posted");
        ...
        builder.HasOne(e => e.OriginalPurchaseReceipt)
            .WithMany()
            .HasForeignKey(e => e.OriginalPurchaseReceiptId)
            .OnDelete(DeleteBehavior.Restrict);
